...
def init(path):
    ...
    # 字符字体
    globals.set_value('fonts', '/System/Library/Fonts/Arial Unicode.ttf')
    # 生成视频帧率
    ...
    # 与原视频速度相同的无声像素动画名称
    soundless_video = globals.get_value('project_folder') + 'soundless_' + os.path.basename(
        globals.get_value('name_of_original_video')).split('.')[
        0] + '.mp4'
